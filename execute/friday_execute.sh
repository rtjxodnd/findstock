...
echo '전종목 이평선 설정';
/home/ubuntu/venv_findstock/bin/python3 /home/ubuntu/project_findstock/main/14_set_stc_move_average.py friday > /home/ubuntu/project_findstock/logs/14_set_stc_move_average.log;
}